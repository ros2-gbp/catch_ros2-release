## catch_ros2 (kilted) - 0.2.3-1

The packages in the `catch_ros2` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted catch_ros2` on `Sat, 06 Sep 2025 07:12:53 -0000`
